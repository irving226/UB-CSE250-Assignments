...
void test_p2_a() {
	...
	// Actual
	bool actual1 = iterative_sub_vector(masterVec, test1);
	bool actual2 = iterative_sub_vector(masterVec, test2);
...
void test_p2_b() {
	...
	// Actual
	bool actual1 = recursive_sub_vector(masterVec, test1, 0);
	bool actual2 = recursive_sub_vector(masterVec, test2, 0);
